...
private:
	...
	vr::VRActionHandle_t m_actionActivateNNRight = vr::k_ulInvalidActionHandle;
	vr::VRActionHandle_t m_actionActivateNNLeft = vr::k_ulInvalidActionHandle;
	...
	bool m_bViveActivateNNRight;
	bool m_bViveActivateNNLeft;
